...
Version 1.1.9 custom firmware for the JC4880P443C_I_W / ESP32-P4 Function EV Board profile.
...
- Version 1.1.9 validates at `0x645240`, leaving `0x14ADC0` bytes free in the smaller OTA app slot.
