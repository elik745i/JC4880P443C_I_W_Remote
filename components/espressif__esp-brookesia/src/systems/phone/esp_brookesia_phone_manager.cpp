...
bool ESP_Brookesia_PhoneManager::beginQuickAccessOverlay(void)
{
    ...
    lv_obj_set_size(_quick_access_mic_gain_slider, 24, 176);
    lv_obj_align(_quick_access_mic_gain_slider, LV_ALIGN_BOTTOM_RIGHT, -24, -16);
    lv_obj_set_style_pad_all(_quick_access_mic_gain_slider, 4, LV_PART_MAIN);
    lv_obj_set_style_bg_color(_quick_access_mic_gain_slider, lv_color_hex(0x334155), LV_PART_MAIN);
    lv_obj_set_style_bg_opa(_quick_access_mic_gain_slider, LV_OPA_COVER, LV_PART_MAIN);
    lv_obj_set_style_radius(_quick_access_mic_gain_slider, LV_RADIUS_CIRCLE, LV_PART_MAIN);
    ...
    lv_obj_set_style_bg_opa(_quick_access_mic_gain_slider, LV_OPA_COVER, LV_PART_INDICATOR);
    lv_obj_set_style_radius(_quick_access_mic_gain_slider, LV_RADIUS_CIRCLE, LV_PART_INDICATOR);
    lv_obj_set_style_bg_color(_quick_access_mic_gain_slider, lv_color_hex(0xF8FAFC), LV_PART_KNOB);
    lv_obj_set_style_bg_opa(_quick_access_mic_gain_slider, LV_OPA_COVER, LV_PART_KNOB);
    lv_obj_set_style_radius(_quick_access_mic_gain_slider, LV_RADIUS_CIRCLE, LV_PART_KNOB);
    lv_obj_set_style_shadow_width(_quick_access_mic_gain_slider, 14, LV_PART_KNOB);
    lv_obj_set_style_shadow_color(_quick_access_mic_gain_slider, lv_color_hex(0x86EFAC), LV_PART_KNOB);
    lv_obj_set_style_shadow_opa(_quick_access_mic_gain_slider, LV_OPA_70, LV_PART_KNOB);
    lv_obj_set_style_outline_width(_quick_access_mic_gain_slider, 2, LV_PART_KNOB);
    lv_obj_set_style_outline_color(_quick_access_mic_gain_slider, lv_color_hex(0x14532D), LV_PART_KNOB);
    lv_obj_set_ext_click_area(_quick_access_mic_gain_slider, 20);
    lv_obj_add_event_cb(_quick_access_mic_gain_slider, onQuickAccessVolumeSliderEventCallback, LV_EVENT_VALUE_CHANGED, this);
    lv_obj_add_event_cb(_quick_access_mic_gain_slider, onQuickAccessVolumeSliderEventCallback, LV_EVENT_PRESSING, this);
