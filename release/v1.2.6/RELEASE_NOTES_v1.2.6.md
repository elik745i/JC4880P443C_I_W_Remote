...
- Hardened the SEGA app with safer Genesis save-state loading, compatibility rejection for older broken Genesis states, fullscreen gameplay chrome cleanup, and smoother browser / load-picker behavior.
...
- Main ESP32-P4 OTA app image: `0x667590` bytes, leaving `0x128A70` bytes free in the smaller OTA slot.
